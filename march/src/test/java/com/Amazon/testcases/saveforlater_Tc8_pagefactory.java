...
import com.Amazon.pageobjects.saveforlater_pagefactory;
import com.Amazon.pageobjects.viewcartcount_pagefactory;
	...
	public class saveforlater_Tc8_pagefactory {
		@Test
		public void Tc8_pagefactory() throws IOException, InterruptedException {
			// TODO Auto-generated method stub
		String projectpath=System.getProperty("user.dir");
		ExtentReports extent=new ExtentReports();
		ExtentSparkReporter spark=new ExtentSparkReporter(projectpath+"\\Reports\\TC9.html");
		extent.attachReporter(spark);
		ExtentTest test=extent.createTest("product is sent to save for later  from the cart in Amazon");
	...
	String password=sheet.getRow(i).getCell(1).getStringCellValue();
		     ...
		     saveforlater_pagefactory obj=PageFactory.initElements(driver,saveforlater_pagefactory.class);
	       ...
	       obj.clickonyouraccount();
		    ...
		    obj.clickonSaveforlater();
		    test.pass("product is sent to save for later  from the cart successfully");
		      driver.quit();
		      extent.flush();  
	 }
	}
