...
import io.github.bonigarcia.wdm.WebDriverManager;
	...
	public class viewcartcount_Tc6_pagefactory {
@Test
		...
		ExtentTest test=extent.createTest("View the cart count in Amazon");
	...
	String password=sheet.getRow(i).getCell(1).getStringCellValue();
		     ...
		     viewcartcount_pagefactory obj=PageFactory.initElements(driver,viewcartcount_pagefactory.class);
...
obj.clickonyouraccount();
		   ...
		   obj.clickonviewcart();
		  test.pass("no of Items in the cart is viewed successfully");
